...
(setq java-font-lock-keywords
      (list
       '("\\<\\(if\\|then\\|else\\|switch\\|case\\|break\\|do\\|else\\|while\\|return\\|null\\|true\\|false\\|import\\|package\\|new\\|throws?\\|extends\\|implements\\|try\\|catch\\|finally\\|synchronized\\|class\\|interface\\|abstract\\|final\\|static\\|public\\|protected\\|private\\)\\>"
	 ...
	 (1 font-lock-variable-name-face)
       ...
       '("\\(class\\|interface\\|new\\)\\W*\\<\\([A-Z1-90]*\\)\\>"
	 (2 font-lock-type-face t)
	 )
       '("\\<\\(void\\|boolean\\|char\\|byte\\|short\\|int\\|long\\|float\\|double\\|[A-Z]\\w*\\)\\>"
	 (1 font-lock-type-face t)
	 )
       '("\\<\\(package\\|import\\)\\>\\W*\\([a-zA-Z1-90.*]*\\)\\W*;"
...
(setq tcl-font-lock-keywords
      (list
       ...
       '("\\<\\(class\\|body\\|configbody\\|method\\|proc\\)\\>[ \t]*\\(\\sw+\\)?"
     ...
     (cons (concat "\\<\\(common\\|global\\|inherit\\|"
		   "p\\(rotected\\|ublic\\)\\|upvar\\|variable\\)\\>")
	   'font-lock-type-face)
     ))
...
(setq tcl-imenu-generic-expression
      (list
  '("Procs" "^[ \t]*proc[ \t]+\\(\\(\\s_\\|\\sw\\)+\\)" 1)
  '("Classes" "^[ \t]*class[ \t]+\\(\\(\\s_\\|\\sw\\)+\\)" 1)
  '("Methods" "^[ \t]*body[ \t]+\\(\\sw+::\\(\\s_\\|\\sw\\)+\\)" 1)
  '("Configure Methods" "^[ \t]*configbody[ \t]+\\(\\sw+::\\(\\s_\\|\\sw\\)+\\)" 1)
  ))
...
(font-lock-add-keywords
 ...
 '(("\\<\\(FIXME\\):" 1 font-lock-warning-face prepend)
   ("\\<\\(TODO\\)\\>" 1 font-lock-variable-name-face prepend)))
...
(add-hook 'java-mode-hook
	  '(lambda () (make-local-variable 'font-lock-defaults)
	     (setq font-lock-defaults '(java-font-lock-keywords nil nil ((?_ ."w")) beginning-of-defun
